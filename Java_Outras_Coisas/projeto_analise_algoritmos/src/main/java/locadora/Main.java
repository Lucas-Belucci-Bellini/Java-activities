...
/**
 * Ponto de entrada com um menu de demonstracao das operacoes da locadora.
 */
public class Main {

    /**
     * Cria a classe de entrada da aplicacao.
     */
    public Main() {
    }

    /**
     * Executa o menu interativo da aplicacao.
     *
    ...
    /**
     * Exibe as opcoes disponiveis no menu.
     */
